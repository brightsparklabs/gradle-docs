...
public class DocsPlugin implements Plugin<Project> {
     ...
     * @param jinjaOutputDir Directory of the asciidoc files generated by jinja to be copied
     */

    private void setupJekyll(Project project, File jekyllOutputDir, File jinjaOutputDir) {

        //Create task for building the website using Jekyll-Asciidoc
        project.task('bslJekyllBuild'){
            group = "brightSPARK Labs - Docs"
        ...
        project.afterEvaluate {
            project.bslJekyllBuild.dependsOn project.jinjaPreProcess
        }
    }
